...
class RealtimeFaceDetection extends StatefulWidget {
  RealtimeFaceDetection({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  _RealtimeFaceDetectionState createState() => _RealtimeFaceDetectionState();
}
  ...
  initializeCamera() async {
    ...
    await controller.initialize().then((_) {
      ...
      controller.startImageStream((image) => {
            if (isBusy!=true) {isBusy = true, img = image, doFaceDetectionOnFrame()}
          });
    });
  }
